        ...
        <div className="px-4 py-6 sm:p-8">
          <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="sm:col-span-6 border-t border-gray-200 pt-6 mt-2">
              <h4 className="text-lg font-medium text-gray-900 mb-4">Reset Password (Opsional)</h4>
              <div className="max-w-md">
                ...
                <p className="mt-1 text-xs text-gray-500">Jika diisi, password pengguna akan langsung diubah.</p>
              </div>
            </div>
