  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button 
        ...
        className="relative p-1.5 sm:p-2 rounded-full text-gray-500 hover:text-[#C62828] hover:bg-red-50 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500"
      >
