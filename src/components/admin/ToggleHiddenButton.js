...
export default function ToggleHiddenButton({ productId, initialIsHidden }) {
  const [isHidden, setIsHidden] = useState(initialIsHidden || false);
  ...
  return (
    <button
      ...
      disabled={isLoading}
      title={isHidden ? "Tampilkan Produk" : "Sembunyikan Produk"}
